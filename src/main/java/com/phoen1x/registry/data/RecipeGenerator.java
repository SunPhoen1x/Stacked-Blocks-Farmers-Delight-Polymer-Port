...
public class RecipeGenerator extends net.minecraft.data.recipe.RecipeGenerator {
    ...
    public void generate() {
        ...
        compressBlockRecipe(BlockRegistry.STACKED_RAW_IRON_BLOCKS_ITEM, Items.RAW_IRON, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_RAW_GOLD_BLOCKS_ITEM, Items.RAW_GOLD, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_RAW_COPPER_BLOCKS_ITEM, Items.RAW_COPPER, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_LAPIS_BLOCKS_ITEM, Items.LAPIS_LAZULI, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_REDSTONE_BLOCKS_ITEM, Items.REDSTONE, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_COAL_BLOCKS_ITEM, Items.COAL, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_IRON_BLOCKS_ITEM, Items.IRON_INGOT, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_GOLD_BLOCKS_ITEM, Items.GOLD_INGOT, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_EMERALD_BLOCKS_ITEM, Items.EMERALD, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_DIAMOND_BLOCKS_ITEM, Items.DIAMOND, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_NETHERITE_BLOCKS_ITEM, Items.NETHERITE_INGOT, ModItems.ROPE.get(), exporter);
        compressBlockRecipe(BlockRegistry.STACKED_QUARTZ_BLOCKS_ITEM, Items.QUARTZ, ModItems.ROPE.get(), exporter);
