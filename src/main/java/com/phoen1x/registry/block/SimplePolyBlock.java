package com.phoen1x.registry.block;
...
public class SimplePolyBlock extends Block implements PolymerTexturedBlock {
    ...
    public SimplePolyBlock(Settings settings, String path) {
        super(settings);
        model = PolymerBlockResourceUtils.requestBlock(BlockModelType.FULL_BLOCK, PolymerBlockModel.of(Identifier.of(Stackedblocksfarmersdelightport.MOD_ID, "block/"+path)));
    }
